<template>
        ...
        <ul class="blog-listing detail">
          <li>
            <div class="image-zoom-container" @click="openImageModal">
              <img
                :src="buildSafeImageUrl(publicacionData.publicaciones_imagen)"
            ...
            <p class="left-aligned" v-html="$sanitize(publicacionData.publicaciones_descripcion)"></p>
  ...
  <div v-if="showImageModal" class="image-modal-overlay" @click="closeImageModal">
    <div class="image-modal-content" @click.stop>
      ...
      <img 
        :src="buildSafeImageUrl(publicacionData.publicaciones_imagen)" 
        :alt="publicacionData.publicaciones_titulo"
        class="modal-image"
      />
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...mapState(["publicaciones", "Institucion"]),
    ...
    publicacionData() {
      ...
      if (!pubId || !this.publicaciones?.length) return null;
      const publicacion = this.publicaciones.find(p => p.publicaciones_id === pubId);
      if (!publicacion || !publicacion.publicaciones_id || !publicacion.publicaciones_imagen) return null;
      return publicacion;
    },
